...
//        disposables += syncMessages
        ...
        // Show the syncing UI
        disposables.add(syncRepository.syncProgress
        ...
        // Show the rating UI
        disposables.add(ratingManager.shouldShowRating
        ...
        if (permissionManager.hasContacts()) {
            disposables.add(contactAddedListener.listen()
    ...
    override fun bindView(view: MainView) {
        ...
        if (changelogManager.didUpdate()) {
            if (Locale.getDefault().language.startsWith("en")) {
                disposables.add(changelogManager.getChangelog()
